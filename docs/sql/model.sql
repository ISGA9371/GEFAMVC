...
CREATE TABLE IF NOT EXISTS `GESTION_FACTORIA`.`THGE017_REQUERIM` (
  ...
  `NU_HORA_REQ` DECIMAL(4,2) NULL,
  `NU_HRS_TOT` DECIMAL(4,2) NULL,
  `NU_HRS_FACT` DECIMAL(4,2) NULL,
  `NU_HRS_SIN_FACT` DECIMAL(4,2) NULL,
