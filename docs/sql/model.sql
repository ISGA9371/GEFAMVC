...
CREATE TABLE IF NOT EXISTS `GESTION_FACTORIA`.`THGE011_USUARIO` (
  `CD_USUARIO` INT(9) NOT NULL AUTO_INCREMENT,
  `CD_USUARIO_CORP` VARCHAR(10) NOT NULL,
  `CD_USUARIO_RESP` INT(4) NULL,
...
CREATE TABLE IF NOT EXISTS `GESTION_FACTORIA`.`THGE007_PEP` (
  `CD_CONSEC_PEP` INT(9) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `GESTION_FACTORIA`.`THGE010_NIVEL` (
  `CD_CONSEC_NIVEL` INT(4) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `GESTION_FACTORIA`.`THGE057_APLICACION` (
  `CD_CONS_APLIC` INT(4) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `GESTION_FACTORIA`.`THGE056_CANAL` (
  `CD_CONS_CANAL` INT(4) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `GESTION_FACTORIA`.`THGE013_TIPO_PI` (
  `CD_TIPO_PI` INT(9) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `GESTION_FACTORIA`.`THGE017_REQUERIM` (
  ...
  CONSTRAINT `R0170138`
    FOREIGN KEY ()
    REFERENCES `GESTION_FACTORIA`.`THGE013_TIPO_PI` ()
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `GESTION_FACTORIA`.`THGE024_CTRL_EXT` (
  `CD_EXTERNO` INT(9) NOT NULL AUTO_INCREMENT,
  ...
  `CD_AREA` INT(4) NOT NULL,
  `CD_USUARIO_RESP` VARCHAR(10) NOT NULL,
  `TX_HOST` CHAR(2) NULL DEFAULT 'NO',
  `TX_VPN` CHAR(9) NULL,
  ...
  `FH_ALTA` DATE NULL,
  `FH_BAJA` DATE NULL,
  PRIMARY KEY (`CD_EXTERNO`, `CD_TP_PROYECTO`),
...
CREATE TABLE IF NOT EXISTS `GESTION_FACTORIA`.`THGE026_MODIF` (
  ...
  `TX_MOD_EN_VUELO` CHAR(2) NOT NULL DEFAULT 'CHECK(TX_MOD_EN_VUELO IN(\'SI\', \'NO\'))',
  `TX_MOD_RZDA_DYD` CHAR(2) GENERATED ALWAYS AS ('CHECK(TX_MOD_RZDA_DYD IN(\'SI\', \'NO\'))') VIRTUAL,
  ...
  `TX_DIFICULTAD_INI` CHAR(1) NULL DEFAULT 'CHECK(TX_DIF_INI IN(\'0\',\'1\', \'2\', \'3\', \'4\', \'F\'))',
  `IM_COSTE_INIC` DOUBLE NULL,
  `HM_INICIAL` DOUBLE NULL,
  `TX_DIF_EMP` CHAR(1) NULL DEFAULT 'CHECK(TX_DIF_EMP IN(\'0\',\'1\', \'2\', \'3\', \'4\', \'F\'))',
  `IM_COSTE_EMP` DOUBLE NULL,
  `HM_EMPR` DOUBLE NULL,
  `TX_COM_TIPIF_EMP` VARCHAR(500) NULL,
  `ST_TIPIF` INT(4) NOT NULL,
  `TX_FACT_S_N` CHAR(2) NOT NULL DEFAULT 'CHECK(TX_FACT_S_N IN(\'SI\', \'NO\'))',
  `CD_PRIORIDAD_USU` INT(4) NOT NULL,
  `CD_USU_PETICION` VARCHAR(10) NOT NULL,
  `CD_ORIGEN` INT(4) NOT NULL,
  `CD_RESP_RESOL` VARCHAR(10) GENERATED ALWAYS AS () VIRTUAL,
...
CREATE TABLE IF NOT EXISTS `GESTION_FACTORIA`.`THGE041_SEG_PAGO` (
  `CD_CONS_SEG_PAGO` INT(9) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `GESTION_FACTORIA`.`THGE039_FACTURA` (
  ...
  `NB_GLG` CHAR(23) NULL DEFAULT 'DEFAULT \'GLG HARDWARE Y SOFTWARE\'',
  ...
  `TX_SEM_PRES_SUF` INT(1) NULL DEFAULT CHECK(TX_SEM_PRES_SUF IN(0,1)),
  `TX_SEM_PER_SUBD` INT(1) NULL DEFAULT CHECK(TX_SEM_PER_SUBD IN(0,1)),
  `TX_SEM_TP_PRES` INT(1) NULL DEFAULT CHECK(TX_SEM_TP_PRES IN(0,1)),
  `TX_SEM_SUBD_CORR` INT(1) NULL DEFAULT CHECK(TX_SEM_SUBD_CORR IN(0,1)),
...
CREATE TABLE IF NOT EXISTS `GESTION_FACTORIA`.`THGE044_C204` (
  ...
  `CD_CASO_PRUEBA` VARCHAR(12) NOT NULL DEFAULT 'CHECK(SUBSTR(CD_CASO_PRUEBA,1,2)=\'CP\')',
  `CD_PRIORIDAD_CP` INT(4) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `GESTION_FACTORIA`.`THGE058_CTRL_ACC` (
  ...
  CONSTRAINT `R0580243`
    ...
    REFERENCES `GESTION_FACTORIA`.`THGE024_CTRL_EXT` (`CD_EXTERNO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `GESTION_FACTORIA`.`THGE062_EVAL_SERV` (
  ...
  PRIMARY KEY (`CD_EMPRESA`, `CD_TECNOLOGIA`, `FH_INICIO`, `FH_FIN`),
...
CREATE TABLE IF NOT EXISTS `GESTION_FACTORIA`.`THGE059_H_C_MANDO` (
  ...
  PRIMARY KEY (`CD_EMPRESA`, `CD_TECNOLOGIA`, `FH_INICIO`, `FH_FIN`, `CD_METRICA`),
...
CREATE TABLE IF NOT EXISTS `GESTION_FACTORIA`.`THGE063_SEG_REQ` (
  ...
  PRIMARY KEY (`CD_SEG_REQ`, `CD_REQUERIMIENTO`),
...
CREATE TABLE IF NOT EXISTS `GESTION_FACTORIA`.`THGE064_TP_IDENTIF` (
  `CD_IDENTIFICACION` INT(4) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `GESTION_FACTORIA`.`THGE068_LOG_FH_COM` (
  ...
  CONSTRAINT `R0680091`
    FOREIGN KEY ()
    REFERENCES `GESTION_FACTORIA`.`THGE070_TP_FH` ()
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `R0680702`
