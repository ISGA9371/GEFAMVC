...
public class Status implements Serializable {
    ...
    @JsonIgnore
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "status")
    private List<com.mx.bbva.business.model.Access> accessList;
    @JsonIgnore
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "status")
    ...
    public List<com.mx.bbva.business.model.Access> getAccessList() {
        return accessList;
    }

    public void setAccessList(List<com.mx.bbva.business.model.Access> accessList) {
