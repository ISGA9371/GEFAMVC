...
@NamedQueries({
        @NamedQuery(name = "Severidad.findAll", query = "SELECT t FROM Severidad t")})
public class Severidad implements Serializable {
    ...
    public Severidad(Integer cdSeveridad) {
        this.cdSeveridad = cdSeveridad;
    }

    public Severidad(Integer cdSeveridad, String nbSeveridad) {
        this.cdSeveridad = cdSeveridad;
    ...
    public String toString() {
        return "com.bbva.Severidad[ cdSeveridad=" + cdSeveridad + " ]";
    }
