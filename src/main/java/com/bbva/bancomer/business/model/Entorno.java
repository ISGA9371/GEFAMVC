...
@NamedQueries({
        @NamedQuery(name = "Entorno.findAll", query = "SELECT t FROM Entorno t")})
public class Entorno implements Serializable {
    ...
    public Entorno(Integer cdEntorno) {
        this.cdEntorno = cdEntorno;
    }

    public Entorno(Integer cdEntorno, String nbEntorno) {
        this.cdEntorno = cdEntorno;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Entorno)) {
            return false;
        }
        Entorno other = (Entorno) object;
    ...
    public String toString() {
        return "com.bbva.Entorno[ cdEntorno=" + cdEntorno + " ]";
    }
