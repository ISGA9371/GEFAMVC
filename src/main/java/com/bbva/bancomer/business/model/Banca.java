...
@NamedQueries({
        @NamedQuery(name = "Banca.findAll", query = "SELECT t FROM Banca t")})
public class Banca implements Serializable {
    ...
    public Banca(Integer cdBanca) {
        this.cdBanca = cdBanca;
    }

    public Banca(Integer cdBanca, String nbBanca) {
        this.cdBanca = cdBanca;
    ...
    public String toString() {
        return "com.bbva.Banca[ cdBanca=" + cdBanca + " ]";
    }
