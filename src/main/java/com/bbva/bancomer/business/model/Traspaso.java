...
public class Traspaso implements Serializable {
    ...
    public Traspaso(Integer cdTraspaso) {
        this.cdTraspaso = cdTraspaso;
    }

    public Traspaso(Integer cdTraspaso, Date fhTraspaso) {
        this.cdTraspaso = cdTraspaso;
    ...
    public Nivel getCdNivelSubdir() {
        return cdNivelSubdir;
    }

    public void setCdNivelSubdir(Nivel cdNivelSubdir) {
    ...
    public String toString() {
        return "com.bbva.Traspaso[ cdTraspaso=" + cdTraspaso + " ]";
    }
