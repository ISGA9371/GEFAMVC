...
@NamedQueries({
        @NamedQuery(name = "CausaCier.findAll", query = "SELECT t FROM CausaCier t")})
public class CausaCier implements Serializable {
    ...
    public CausaCier(Integer cdConsCausaC) {
        this.cdConsCausaC = cdConsCausaC;
    }

    public CausaCier(Integer cdConsCausaC, int cdCausaCierre, String nbCausaCierre) {
        this.cdConsCausaC = cdConsCausaC;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CausaCier)) {
            return false;
        }
        CausaCier other = (CausaCier) object;
    ...
    public String toString() {
        return "com.bbva.CausaCier[ cdConsCausaC=" + cdConsCausaC + " ]";
    }
