...
@NamedQueries({
        @NamedQuery(name = "CatCaso.findAll", query = "SELECT t FROM CatCaso t")})
public class CatCaso implements Serializable {
    ...
    public CatCaso(Integer cdCategoriaCaso) {
        this.cdCategoriaCaso = cdCategoriaCaso;
    }

    public CatCaso(Integer cdCategoriaCaso, String nbCategoriaCaso) {
        this.cdCategoriaCaso = cdCategoriaCaso;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CatCaso)) {
            return false;
        }
        CatCaso other = (CatCaso) object;
    ...
    public String toString() {
        return "com.bbva.CatCaso[ cdCategoriaCaso=" + cdCategoriaCaso + " ]";
    }
